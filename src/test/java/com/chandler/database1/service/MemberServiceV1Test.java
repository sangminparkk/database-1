...
class MemberServiceV1Test {
    ...
    private RepositoryV1 memberRepository;
    private MemberServiceV1 memberServiceV1;

    @BeforeEach
    void before() {
        DriverManagerDataSource dataSource = new DriverManagerDataSource(URL, USERNAME, PASSWORD);
        memberRepository = new RepositoryV1(dataSource);
    ...
    public void accountTransfer() throws Exception {
        ...
        // when
        memberServiceV1.accountTransfer(fromMember.getMember_Id(), toMember.getMember_Id(), 2000);
    ...
    public void accountTransfer_member_ex() throws Exception {
        ...
        //when
        assertThrows(IllegalArgumentException.class, () -> memberServiceV1.accountTransfer(fromMember.getMember_Id(), toMember.getMember_Id(), 2000));
        Member fromId = memberRepository.findById(fromMember.getMember_Id());
        Member toId = memberRepository.findById(toMember.getMember_Id());
